...
# Зарегистрируйте приложение hello в файле first_project/settings.py
# Добавить файл urls.py приложение hello
...
# 6. Создание моделей в models.py и потом миграции :
